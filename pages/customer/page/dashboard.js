        ...
        {jsonData !== null && (
          <div className="m-4">
            ...
            {jsonData.map(product =>
              ...
              <div className="card w-60 bg-base-100 shadow-xl flex float-left ml-4 h-100">
                <Link href={`./${product.productid}`}>
                <figure><img src={process.env.NEXT_PUBLIC_BACKEND_URL + `productpic/${product.picture}`} height="200" width="200" /></figure>
                </Link>
