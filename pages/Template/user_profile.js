                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 ">
                            ...
                            <div class="col-span-2">
                                ...
                                <div className="flex flex-col justify-center max-w-xs p-8 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
                                    <img  src={`http://localhost:3000/employee/getimage/${jsonData.filename}`} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
                                    <div className="space-y-4 text-center divide-y divide-gray-700">
                                        <div className="my-2 space-y-1">
                                            <h2 className="text-xl font-semibold sm:text-2xl">{jsonData.fname} {jsonData.lname} </h2>
                                            <p className="px-5 text-xs sm:text-base dark:text-gray-400">{jsonData.email}</p>
                                            <p className="px-5 text-xs sm:text-base dark:text-gray-400">{jsonData.phone}</p>
                                            <p className="px-5 text-xs sm:text-base dark:text-gray-400">Employee</p>
                                        ...
                                        <div className="flex justify-center pt-2 space-x-4 align-center">
                                            ...
                                            <button className="btn btn-active btn-accent">Edit Profile</button> 
                                            </a>
                                            <a rel="noopener noreferrer" href="delete_profile" aria-label="" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                                            <button className="btn btn-error">Delete Account</button>
                                            </a>
                                        </div>
                                        <div className="flex justify-center pt-2 space-x-4 align-center">
                                            <a rel="noopener noreferrer" href="changepic" aria-label="" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                                                <button className="btn btn-outline btn-secondary">Change Profile Picture</button>
                                            </a>
