...
export default function Add_product() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await axios.post("http://localhost:3000/employee/addproduct",
                formData, {
                headers: {
                            ...
                            <h1 className="text-3xl font-semibold text-center text-black-700  uppercase decoration-wavy">
                             Add Product
                                    ...
                                    <div className="mb-2">
                                        ...
                                        {errors.price &&
                                            <p id="" class=""><span class=""> Price is required</span></p>
                                        }
                                    ...
                                    <div className="mb-2">
                                        ...
                                        {errors.discount &&
                                            <p id="" class=""><span class=""> Discount is required</span></p>
                                        }
                                    ...
                                    <div>
                                        ...
                                        <td>
                                            <label class="" for="file_input">Upload file</label>
                                        </td>
                                        <td>
                                            <input
                                                type="file"
                                                ...
                                                className="block w-full px-4 py-2 mt-2 text-black-700 bg-white focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                            />
                                        </td>
                                        <td>
                                            {errors.filename &&
                                    ...
                                    <div>
                                        <tr>
                                            ...
                                            <td>
                                                {errors.employee &&
                                                    <p id="" class=""><span class="">Employee Id is required</span></p>
                                                }
                                            </td>
