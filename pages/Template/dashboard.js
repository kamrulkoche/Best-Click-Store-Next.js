                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 ">
                                ...
                                <div className="h-full p-3 space-y-2 w-60 dark:bg-gray-900 dark:text-gray-100">
                                    ...
                                    <div className="divide-y divide-gray-700">
                                        ...
                                        <ul className="pt-4 pb-2 space-y-1 text-sm">
                                            ...
                                            <li>
                                                <Link rel="noopener noreferrer" href="view" className="flex items-center p-2 space-x-3 rounded-md">
                                                    <svg
                                                        fill="#000000"
                                                        height="24"
                                                        viewBox="0 0 24 24"
                            ...
                            <div class="col-span-2">
                                ...
                                <div className="hero full-screen bg-base-200">

                                    <div className="hero-content flex-col lg:flex-row-reverse">

                                        <img src="/image/best_click.png" className="max-w-sm rounded-lg shadow-4x2" />
                        ...
                        {/*                         
                <fieldset>
                    <a href='delete_profile'><h3 align="right">Delete Profile</h3></a>
                    ...
                    <a href='product_add'><h3 align="left">Add Product</h3></a>
                    <a href='product_view'><h3 align="left">Product View</h3></a>
                    <a href='product_update'><h3 align="left">Product Update</h3></a>
                    <a href='help_line'><h3 align="left">Help Line</h3></a>
                    <a href='/'><h3 align="left">Log Out</h3></a>
                </fieldset> */}
                    </div>
                )
                }
