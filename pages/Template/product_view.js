                                    ...
                                    <table className="table">
                                        <tbody>
                                            <tr className="bg-pink-200">
                                                ...
                                                <th>PRICE</th> {/* Corrected the table header */}
                                                <th>DISCOUNT</th>
                                                <th>UPDATE</th> {/* Add Edit header */}
                                                <th>DELETE</th>
                                            </tr>
                                            <br></br>
                                            {filteredData.map((item) => (
                                                <tr key={item.id} className="bg-white-200">
                                                    ...
                                                    <div className="mask mask-squircle w-12 h-12">
                                                        <img src={`http://localhost:3000/employee/getproduct/${item.filename}`} alt="Avatar Tailwind CSS Component" />
                                                    </div>
