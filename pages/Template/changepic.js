...
export default function ChangeProfile() {
    ...
    async function changeprofilepic() {
        try {
            ...
            const response = await axios.put(`http://localhost:3000/employee/changeprofile`,  formData, {
                headers: {
            ...
            {jsonData !== null && (
                ...
                <div className="detaills w-full float-left justify-center align-items-center flex flex-row  mt-10" >
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="file" name="filename" id="filename" className="file-input file-input-bordered w-full max-w-xs" onChange={handleChangeProfile} />
                        <p align="center"><button type="submit" className="btn  hover:bg-green-300 mt-10">Change</button></p>
