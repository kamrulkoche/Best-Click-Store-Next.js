...
export default function Delete_profile() {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            await axios.delete(`http://localhost:3000/employee/users/${jsonData.id}`);
            //   console.log("DONE!");
            router.push('sign_in');
        } catch (error) {
            console.log(error);
                            ...
                            <div class="col-span-2">
                                <div className="flex flex-col max-w-md gap-2 p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
                                    <h2 className="flex items-center gap-2 text-xl font-semibold leadi tracki">
                                        ...
                                        </svg>Confirm Deletion
                                    </h2>
                                    <p className="flex-1 dark:text-gray-400">This will delete this account permanently. You cannot undo this action. </p>
                                    <div className="flex flex-col justify-end gap-3 mt-6 sm:flex-row">
                                        <button className="btn btn-success"> <a href='dashboard'>No </a></button>
